...
pygame.init()
s = pygame.mixer.Sound('./35 занятие/sound.wav')
win = pygame.mixer.Sound('./35 занятие/win.wav')
scorep1 = 0
scorep2 = 0
x1 = (490)
y1 = 250
...
def collision():
    ...
    def restart():
        ...
        global x, y
        scorep2 += 10
        pygame.display.set_caption("Ping Pong" + "Score player 1: " + str(scorep1) + " - Score player 2: " + str(scorep2))
